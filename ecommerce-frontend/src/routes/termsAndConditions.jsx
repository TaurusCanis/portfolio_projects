...
<p>
    This website is operated by LHWD, LLC. Throughout the site, the terms “we”, “us” and “our” refer to LHWD, LLC. LHWD,
    LLC
...
<p>
    Any new features or tools which are added to the current site shall also be subject to the Terms of Service. You can
...
<p>
    ...
    any
    other transactions made in connection with any third-party websites. Please review carefully the third-party's
    policies
...
<p>
    In no case shall LHWD, LLC, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers,
...
<p>
    You agree to indemnify, defend and hold harmless LHWD, LLC and our parent, subsidiaries, affiliates, partners,
    officers,
...
<p>
    ...
    construed in
    accordance with the laws of Connecticut, United States.
</p>
<h2>
...
<p>
    Questions about the Terms of Service should be sent to us at admin@tauruscanisrex.com.
</p>
</>
    );
}